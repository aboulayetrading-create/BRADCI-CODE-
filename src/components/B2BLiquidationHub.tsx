...
export const B2BLiquidationHub: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-12 animate-in fade-in duration-300">
      ...
      <section className="relative rounded-3xl overflow-hidden border border-blue-500/30 bg-gradient-to-br from-[#09152C] via-[#081021] to-[#040712] p-5 sm:p-8 lg:p-10 shadow-2xl dark-banner banner-text-white">
